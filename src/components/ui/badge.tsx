  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        success: "border-transparent bg-chart-2/20 text-chart-2 hover:bg-chart-2/30",
        warning: "border-transparent bg-chart-4/20 text-chart-4 hover:bg-chart-4/30",
        info: "border-transparent bg-chart-3/20 text-chart-3 hover:bg-chart-3/30",
      },
    },
    defaultVariants: {
      variant: "default",
